...
public class _40love
{
	...
	****************************************************************************/
	...
	public static Memory_ReadAddress readmem[]={
		...
		new Memory_ReadAddress( 0x8000, 0x87ff, MRA_RAM ),	/* M5517P on main board */
		new Memory_ReadAddress( 0xa000, 0xbfff, MRA_BANK1 ),
	
		new Memory_ReadAddress( 0x9000, 0x97ff, fortyl_bg_videoram_r ),	/* #1 M5517P on video board */
		new Memory_ReadAddress( 0x9800, 0x983f, MRA_RAM ),				/* video control area */
		new Memory_ReadAddress( 0x9840, 0x987f, MRA_RAM ),				/* sprites part 1 */
		new Memory_ReadAddress( 0x9880, 0x98bf, fortyl_bg_colorram_r ),	/* background attributes */
		new Memory_ReadAddress( 0x98c0, 0x98ff, MRA_RAM ),				/* sprites part 2 */
	
		new Memory_ReadAddress( 0xc000, 0xffff, fortyl_pixram_r ),
	
	
		new Memory_ReadAddress( 0x8800, 0x8800, fortyl_mcu_r ),
		new Memory_ReadAddress( 0x8801, 0x8801, fortyl_mcu_status_r ),
	
		//new Memory_ReadAddress( 0x8802, 0x8802, pix1_r ), // this one is here just for debugging
		new Memory_ReadAddress( 0x8803, 0x8803, pix2_r ), // and this one _is_ used.
	
		new Memory_ReadAddress( 0x8804, 0x8804, from_snd_r ),
		new Memory_ReadAddress( 0x8805, 0x8805, snd_flag_r ),
		new Memory_ReadAddress( 0x8807, 0x8807, MRA_NOP ), /* unknown */
	
		new Memory_ReadAddress( 0x8808, 0x8808, input_port_2_r ),
		new Memory_ReadAddress( 0x8809, 0x8809, input_port_4_r ),
		new Memory_ReadAddress( 0x880a, 0x880a, input_port_3_r ),
		new Memory_ReadAddress( 0x880b, 0x880b, input_port_5_r ),
		new Memory_ReadAddress( 0x880c, 0x880c, input_port_0_r ),
		new Memory_ReadAddress( 0x880d, 0x880d, input_port_1_r ),
	...
	public static Memory_WriteAddress writemem[]={
		...
		new Memory_WriteAddress( 0x8800, 0x8800, fortyl_mcu_w ),
		new Memory_WriteAddress( 0x8801, 0x8801, pix1_w ),		//pixel layer related
		new Memory_WriteAddress( 0x8802, 0x8802, bank_select_w ),
		new Memory_WriteAddress( 0x8803, 0x8803, pix2_w ),		//pixel layer related
		new Memory_WriteAddress( 0x8804, 0x8804, sound_command_w ),
	//	new Memory_WriteAddress( 0x8805, 0x8805, MWA_NOP /*sound_reset*/),	//????
		new Memory_WriteAddress( 0x880c, 0x880c, fortyl_pixram_sel_w ), /* pixram bank select */
		new Memory_WriteAddress( 0x880d, 0x880d, MWA_NOP ), /* unknown */
	
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_ReadAddress undoukai_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
	
		new Memory_ReadAddress( 0x0000, 0x7fff, MRA_ROM ),
		new Memory_ReadAddress( 0x8000, 0x9fff, MRA_BANK1 ),
		new Memory_ReadAddress( 0xa000, 0xa7ff, MRA_RAM ),	/* M5517P on main board */
	
		new Memory_ReadAddress( 0xb000, 0xb7ff, fortyl_bg_videoram_r ),	/* #1 M5517P on video board */
		new Memory_ReadAddress( 0xb800, 0xb83f, MRA_RAM ),				/* video control area */
		new Memory_ReadAddress( 0xb840, 0xb87f, MRA_RAM ),				/* sprites part 1 */
		new Memory_ReadAddress( 0xb880, 0xb8bf, fortyl_bg_colorram_r ),	/* background attributes */
		new Memory_ReadAddress( 0xb8c0, 0xb8ff, MRA_RAM ),				/* sprites part 2 */
	
		new Memory_ReadAddress( 0xc000, 0xffff, fortyl_pixram_r ),
	
	
		new Memory_ReadAddress( 0xa800, 0xa800, undoukai_mcu_r ),
		new Memory_ReadAddress( 0xa801, 0xa801, undoukai_mcu_status_r ),
	
		//new Memory_ReadAddress( 0xa802, 0xa802, pix1_r ), // this one is here just for debugging
		new Memory_ReadAddress( 0xa803, 0xa803, pix2_r ), // and this one _is_ used.
	
		new Memory_ReadAddress( 0xa804, 0xa804, from_snd_r ),
		new Memory_ReadAddress( 0xa805, 0xa805, snd_flag_r ),
		new Memory_ReadAddress( 0xa807, 0xa807, MRA_NOP ), /* unknown */
	
		new Memory_ReadAddress( 0xa808, 0xa808, input_port_2_r ),
		new Memory_ReadAddress( 0xa809, 0xa809, input_port_4_r ),
		new Memory_ReadAddress( 0xa80a, 0xa80a, input_port_3_r ),
		new Memory_ReadAddress( 0xa80b, 0xa80b, input_port_5_r ),
		new Memory_ReadAddress( 0xa80c, 0xa80c, input_port_0_r ),
		new Memory_ReadAddress( 0xa80d, 0xa80d, input_port_1_r ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_WriteAddress undoukai_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x0000, 0x7fff, MWA_ROM ),
		new Memory_WriteAddress( 0x8000, 0x9fff, MWA_ROM ),
		new Memory_WriteAddress( 0xa000, 0xa7ff, MWA_RAM ),	/* M5517P on main board */
	
		new Memory_WriteAddress( 0xa800, 0xa800, undoukai_mcu_w ),
		new Memory_WriteAddress( 0xa801, 0xa801, pix1_w ),		//pixel layer related
		new Memory_WriteAddress( 0xa802, 0xa802, bank_select_w ),
		new Memory_WriteAddress( 0xa803, 0xa803, pix2_w ),		//pixel layer related
		new Memory_WriteAddress( 0xa804, 0xa804, sound_command_w ),
		new Memory_WriteAddress( 0xa805, 0xa805, MWA_NOP /*sound_reset*/),	//????
		new Memory_WriteAddress( 0xa807, 0xa807, MWA_NOP ), /* unknown */
