...
public class nemesis
{
	...
	public static InterruptHandlerPtr nemesis_interrupt = new InterruptHandlerPtr() {public void handler()
	{
		if (irq_on != 0)
	...
	public static InterruptHandlerPtr konamigt_interrupt = new InterruptHandlerPtr() {public void handler()
	{
		if (cpu_getiloops() == 0)
		{
		...
		{
			if (irq2_on != 0) cpu_set_irq_line(0, 2, HOLD_LINE);
		}
	} };
	
	public static InterruptHandlerPtr gx400_interrupt = new InterruptHandlerPtr() {public void handler()
	{
		switch (cpu_getiloops())
		{
			...
			case 2:
				if (irq4_on != 0) cpu_set_irq_line(0, 4, HOLD_LINE);
				break;
		}
	} };
	...
	public static InterruptHandlerPtr salamand_interrupt = new InterruptHandlerPtr() {public void handler()
	{
		if (irq_on != 0)
			cpu_set_irq_line(0, 1, HOLD_LINE);
	} };
	
	public static InterruptHandlerPtr blkpnthr_interrupt = new InterruptHandlerPtr() {public void handler()
	{
		if (irq_on != 0)
	...
	***************************************************************************/
	...
	public static GameDriver driver_nemesis	   = new GameDriver("1985"	,"nemesis"	,"nemesis.java"	,rom_nemesis,null	,machine_driver_nemesis	,input_ports_nemesis	,null	,ROT0	,	"Konami", "Nemesis" )
	...
	public static GameDriver driver_twinbee	   = new GameDriver("1985"	,"twinbee"	,"nemesis.java"	,rom_twinbee,null	,machine_driver_gx400	,input_ports_twinbee	,null	,ROT90	,	"Konami", "TwinBee" )
	...
	public static GameDriver driver_salamand	   = new GameDriver("1986"	,"salamand"	,"nemesis.java"	,rom_salamand,null	,machine_driver_salamand	,input_ports_salamand	,null	,ROT0	,	"Konami", "Salamander (version D)", GAME_NO_COCKTAIL )
	public static GameDriver driver_salamanj	   = new GameDriver("1986"	,"salamanj"	,"nemesis.java"	,rom_salamanj,driver_salamand	,machine_driver_salamand	,input_ports_salamand	,null	,ROT0	,	"Konami", "Salamander (version J)", GAME_NO_COCKTAIL )
	public static GameDriver driver_lifefrce	   = new GameDriver("1986"	,"lifefrce"	,"nemesis.java"	,rom_lifefrce,driver_salamand	,machine_driver_salamand	,input_ports_salamand	,null	,ROT0	,	"Konami", "Lifeforce (US)", GAME_NO_COCKTAIL )
	public static GameDriver driver_lifefrcj	   = new GameDriver("1986"	,"lifefrcj"	,"nemesis.java"	,rom_lifefrcj,driver_salamand	,machine_driver_salamand	,input_ports_lifefrcj	,null	,ROT0	,	"Konami", "Lifeforce (Japan)", GAME_NO_COCKTAIL )
	public static GameDriver driver_blkpnthr	   = new GameDriver("1987"	,"blkpnthr"	,"nemesis.java"	,rom_blkpnthr,null	,machine_driver_blkpnthr	,input_ports_blkpnthr	,null	,ROT0	,	"Konami", "Black Panther", GAME_NO_COCKTAIL )
	public static GameDriver driver_citybomb	   = new GameDriver("1987"	,"citybomb"	,"nemesis.java"	,rom_citybomb,null	,machine_driver_citybomb	,input_ports_citybomb	,null	,ROT270	,	"Konami", "City Bomber (World)", GAME_NO_COCKTAIL )
	public static GameDriver driver_citybmrj	   = new GameDriver("1987"	,"citybmrj"	,"nemesis.java"	,rom_citybmrj,driver_citybomb	,machine_driver_citybomb	,input_ports_citybomb	,null	,ROT270	,	"Konami", "City Bomber (Japan)", GAME_NO_COCKTAIL )
	public static GameDriver driver_kittenk	   = new GameDriver("1988"	,"kittenk"	,"nemesis.java"	,rom_kittenk,null	,machine_driver_nyanpani	,input_ports_nyanpani	,null	,ROT0	,	"Konami", "Kitten Kaboodle", GAME_NO_COCKTAIL )
	public static GameDriver driver_nyanpani	   = new GameDriver("1988"	,"nyanpani"	,"nemesis.java"	,rom_nyanpani,driver_kittenk	,machine_driver_nyanpani	,input_ports_nyanpani	,null	,ROT0	,	"Konami", "Nyan Nyan Panic (Japan)", GAME_NO_COCKTAIL )
}
