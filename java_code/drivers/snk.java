...
public class snk
{
	...
	*/
	...
	#define SNK_JOY1_PORT \
		...
		PORT_ANALOGX( 0xf0, 0x00, IPT_DIAL, 25, 10, 0, 0, KEYCODE_Z, KEYCODE_X, IP_JOY_NONE, IP_JOY_NONE );\
	...
	#define SNK_JOY2_PORT \
		...
		PORT_ANALOGX( 0xf0, 0x00, IPT_DIAL | IPF_PLAYER2, 25, 10, 0, 0, KEYCODE_N, KEYCODE_M, IP_JOY_NONE, IP_JOY_NONE );
	...
	static InputPortPtr input_ports_countryc = new InputPortPtr(){ public void handler() { 
		...
		PORT_START(); 
		PORT_ANALOG( 0x7f, 0x40, IPT_TRACKBALL_X , 50, 30, 0, 0x7f);
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 );
	
		PORT_START(); 
		PORT_ANALOG( 0x7f, 0x40, IPT_TRACKBALL_Y , 50, 30, 0, 0x7f);
	...
	static InputPortPtr input_ports_ftsoccer = new InputPortPtr(){ public void handler() { 
		...
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER1, 25, 10, 0, 0, KEYCODE_Z, KEYCODE_X, IP_JOY_NONE, IP_JOY_NONE );
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
	
		PORT_START(); 	/* Only used in the "test mode" in this version */
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER2, 25, 10, 0, 0, KEYCODE_N, KEYCODE_M, IP_JOY_NONE, IP_JOY_NONE );
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
	
		PORT_START(); 	/* Only used in the "test mode" in this version */
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER3, 25, 10, 0, 0, IP_KEY_NONE, IP_KEY_NONE, IP_JOY_NONE, IP_JOY_NONE );
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
	
		PORT_START(); 	/* Only used in the "test mode" in this version */
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER4, 25, 10, 0, 0, IP_KEY_NONE, IP_KEY_NONE, IP_JOY_NONE, IP_JOY_NONE );
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	static InputPortPtr input_ports_tdfever = new InputPortPtr(){ public void handler() { 
		...
		PORT_START(); 
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL, 25, 10, 0, 0, KEYCODE_Z, KEYCODE_X, IP_JOY_NONE, IP_JOY_NONE );
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
