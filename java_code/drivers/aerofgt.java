...
public class aerofgt
{
	...
	static public static MachineInitHandlerPtr machine_init_aerofgt  = new MachineInitHandlerPtr() { public void handler()
	{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_pspikesk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 )	/* 68000 code */
