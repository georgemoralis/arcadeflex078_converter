...
public class omegrace
{
	...
	static public static MachineInitHandlerPtr machine_init_omegrace  = new MachineInitHandlerPtr() { public void handler()
	{
	...
	public static IO_ReadPort readport[]={
		...
		new IO_ReadPort( 0x09, 0x09, watchdog_reset_r ),
	...
	static InputPortPtr input_ports_omegrace = new InputPortPtr(){ public void handler() { 
		...
		PORT_BITX( 0x04, IP_ACTIVE_HIGH, IPT_START2, "2 Players Start (1 credit"));P_KEY_DEFAULT, IP_JOY_DEFAULT )
		PORT_BITX( 0x08, IP_ACTIVE_HIGH, IPT_START4, "2 Players Start (2 credits"));P_KEY_DEFAULT, IP_JOY_DEFAULT )
		PORT_BIT ( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_BIT ( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_BITX( 0x40, IP_ACTIVE_HIGH, IPT_START1, "1 Player Start (1 credit"));P_KEY_DEFAULT, IP_JOY_DEFAULT )
		PORT_BITX( 0x80, IP_ACTIVE_HIGH, IPT_START3, "1 Player Start (2 credits"));P_KEY_DEFAULT, IP_JOY_DEFAULT )
