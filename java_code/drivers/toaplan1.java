...
public class toaplan1
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hellfir1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadPtr rom_demonwl1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadPtr rom_samesam2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadPtr rom_outzonea = new RomLoadPtr(){ public void handler(){ 					/* From board serial number 2122 */
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	*/
	...
	static RomLoadPtr rom_vimana = new RomLoadPtr(){ public void handler(){ 			/* From board serial number 1547.04 (July '94) */
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
	...
	static RomLoadPtr rom_vimana1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1, 0 )	/* Main 68K code */
