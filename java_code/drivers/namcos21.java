...
public class namcos21
{
	...
	public static Memory_WriteAddress writemem_sound[]={
		...
		new Memory_WriteAddress( 0x7000, 0x77ff, namcos2_dualportram_byte_w, mpDualPortRAM ),
	...
	public static Memory_WriteAddress writemem_mcu[]={
		...
		new Memory_WriteAddress( 0x5000, 0x57ff, namcos2_dualportram_byte_w, mpDualPortRAM ),
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0x000000, tile_layout,  0x1000, 0x10 ),
		new GfxDecodeInfo( -1 )
	};
	...
	static InputPortPtr input_ports_default = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPNAME( 0x01, 0x01, "DSW1 (Test Mode"));	PORT_DIPSETTING(	0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(	0x00, DEF_STR( "On") );
