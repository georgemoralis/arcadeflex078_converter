/********************************************************************************
	...
	Data East video emulation & information by Bryan McPhail, mish@tendril.co.uk (c) 2000-2003 Bryan McPhail
...
Note *: Ganbare! Gonta!! 2 / Lady Killer Part 2 - Party Time
	...
	Custom chip 156 = Encrypted ARM cpu (unconfirmed)
	Custom chip 102 = Encrypted 68000 cpu (unconfirmed)
...
public class deco16ic
{
		...
		const data16_t control1)
	{
		...
		if (rowscroll_ptr && (control1&0x60)==0x40) {
			...
			if (tilemap_16x16) {
				...
				/* This calculation looks suspicious, but is definitely correct for CNinja and Robocop 2 */
	...
	void deco16_pf12_update(const data16_t *rowscroll_1_ptr, const data16_t *rowscroll_2_ptr)
	{
		...
		deco16_pf_update(pf2_tilemap_8x8,pf2_tilemap_16x16,rowscroll_2_ptr,deco16_pf12_control[3], deco16_pf12_control[4], deco16_pf12_control[5]>>8, deco16_pf12_control[6]>>8);
	...
	void deco16_pf34_update(const data16_t *rowscroll_1_ptr, const data16_t *rowscroll_2_ptr)
	{
		...
		deco16_pf_update(0,pf4_tilemap_16x16,rowscroll_2_ptr,deco16_pf34_control[3], deco16_pf34_control[4], deco16_pf34_control[5]>>8, deco16_pf34_control[6]>>8);
	...
	#define tilemap_draw_rowcol tilemap_draw
