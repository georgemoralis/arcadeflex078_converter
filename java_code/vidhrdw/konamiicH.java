...
void K054338_update_all_shadows(void);								// called at the beginning of public static VideoUpdateHandlerPtr   = new VideoUpdateHandlerPtr() { public void handler(mame_bitmap bitmap, rectangle cliprect)
