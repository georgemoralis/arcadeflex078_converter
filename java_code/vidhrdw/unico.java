...
public class unico
{
	...
	***************************************************************************/
	...
	static void unico_draw_sprites(struct mame_bitmap *bitmap,const struct rectangle *cliprect)
	{
		int offs;
	...
	static void unico_draw_sprites32(struct mame_bitmap *bitmap,const struct rectangle *cliprect)
	{
		int offs;
