...
public class tecmo16
{
	...
	public static VideoUpdateHandlerPtr video_update_fstarfrc  = new VideoUpdateHandlerPtr() { public void handler(mame_bitmap bitmap, rectangle cliprect)
	{
	...
	public static VideoUpdateHandlerPtr video_update_ginkun  = new VideoUpdateHandlerPtr() { public void handler(mame_bitmap bitmap, rectangle cliprect)
	{
