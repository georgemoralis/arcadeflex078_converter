...
public class sonson
{
	...
	***************************************************************************/
	public static PaletteInitHandlerPtr sonson  = new PaletteInitHandlerPtr() { public void handler(char[] colortable, UBytePtr color_prom)
	{
		int i;
	...
	public static VideoUpdateHandlerPtr sonson  = new VideoUpdateHandlerPtr() { public void handler(mame_bitmap bitmap, rectangle cliprect)
	{
